...
uint SchedulePortModulePass::processCallee(Operation *module,
                                           CallSequenceOp &callSequenceOp,
                                           Operation *findOp) {
...
SchedulePortModulePass::mixedFrameMap_t
SchedulePortModulePass::buildMixedFrameMap(CallSequenceOp &callSequenceOp,
...
void SchedulePortModulePass::addTimepoints(CallSequenceOp &callSequenceOp,
...
void SchedulePortModulePass::sortOpsByTimepoint(SequenceOp &sequenceOp) {
...
void SchedulePortModulePass::removePendingOps() {
