...
//       return success();
//     }
//     if (castOp.arg().getType().getIntOrFloatBitWidth() ==
//     cbitType.getWidth()) {
...
// /// @brief Conversion pattern that drops CastOps that have been made
// redundant
...
//     rewriter.replaceOpWithNewOp<mlir::arith::ExtUIOp>(castOp,
//     castOp.getType(),
//                                                       adaptor.arg());
//     return success();
//   } // matchAndRewrite
