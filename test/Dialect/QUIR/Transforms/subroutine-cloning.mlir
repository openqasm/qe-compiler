...
func.func @classical() -> i32 {
  %ret = arith.constant 32 : i32
  return %ret : i32
}

func.func @sub1(%q0 : !quir.qubit<1>) {
  quir.call_gate @x(%q0) : (!quir.qubit<1>) -> ()
  return
}

func.func @sub2(%q0 : !quir.qubit<1>, %q1 : !quir.qubit<1>, %a1 : !quir.angle<20>) {
...
// CHECK:   func.func @classical() -> i32 {
// CHECK:   func.func @sub1_q0(%arg0: !quir.qubit<1> {quir.physicalId = 0 : i32}) {
// CHECK:   func.func @sub1_q1(%arg0: !quir.qubit<1> {quir.physicalId = 1 : i32}) {
// CHECK:   func.func @sub2_q0_q1(%arg0: !quir.qubit<1> {quir.physicalId = 0 : i32}, %arg1: !quir.qubit<1> {quir.physicalId = 1 : i32}, %arg2: !quir.angle<20>) {
// CHECK:     quir.call_subroutine @sub1_q0(%arg0) : (!quir.qubit<1>) -> ()
// CHECK:   func.func @sub2_q1_q0(%arg0: !quir.qubit<1> {quir.physicalId = 1 : i32}, %arg1: !quir.qubit<1> {quir.physicalId = 0 : i32}, %arg2: !quir.angle<20>) {
