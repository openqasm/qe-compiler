...
func @quir_durations () {
    //%duration_dt0 = quir.constant #quir.duration<10 : !quir.duration<dt>>
    // CHECK: {{.*}} = quir.constant #quir.duration<10 : !quir.duration<dt>>
    %duration_dt1 = quir.constant #quir.duration<10.0 : f64 : !quir.duration<dt>>
    // CHECK: {{.*}} = quir.constant #quir.duration<10.0 : !quir.duration<dt>>
    %duration_s = quir.constant #quir.duration<10.0 : f64 : !quir.duration<s>>
    // CHECK: {{.*}} = quir.constant #quir.duration<10.0 : !quir.duration<s>>
    %duration_ms = quir.constant #quir.duration<10.0 : f64 : !quir.duration<ms>>
    // CHECK: {{.*}} = quir.constant #quir.duration<10.0 : !quir.duration<ms>>
    %duration_us = quir.constant #quir.duration<10.0 : f64 : !quir.duration<us>>
    // CHECK: {{.*}} = quir.constant #quir.duration<10.0 : !quir.duration<us>>
    %duration_ns = quir.constant #quir.duration<10.0 : f64 : !quir.duration<ns>>
    // CHECK: {{.*}} = quir.constant #quir.duration<10.0 : !quir.duration<ns>>
    %duration_ps = quir.constant #quir.duration<10.0 : f64 : !quir.duration<ps>>
    // CHECK: {{.*}} = quir.constant #quir.duration<10.0 : !quir.duration<ps>>
    %duration_fs = quir.constant #quir.duration<10.0 : f64 : !quir.duration<fs>>
