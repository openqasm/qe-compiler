...
// MLIR-CIRCUITS: quir.circuit @circuit_1([[ARG0:%[A-Za-z0-9]+]]: !quir.qubit<1>, [[ARG1:%[A-Za-z0-9]+]]: !quir.qubit<1>) -> (i1, i1) {
...
// MLIR-CIRCUITS: quir.return [[m0]], [[m1]] : i1, i1
...
// MLIR-NO-CIRCUITS: oq3.cbit_assign_bit @c0<1> [0] : i1 = [[MEASURE0]]
// MLIR-NO-CIRCUITS: [[MEASURE1:%.*]] = quir.measure([[QUBIT1]]) : (!quir.qubit<1>) -> i1
// MLIR-NO-CIRCUITS: oq3.cbit_assign_bit @c1<1> [0] : i1 = [[MEASURE1]]
...
// MLIR-CIRCUITS-DAG: oq3.cbit_assign_bit @c0<1> [0] : i1 = [[MEASURE0]]#0
// MLIR-CIRCUITS-DAG: oq3.cbit_assign_bit @c1<1> [0] : i1 = [[MEASURE0]]#1
measure $0 -> c0;
measure $1 -> c1;
