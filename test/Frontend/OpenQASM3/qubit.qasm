...
// MLIR: %[[LOAD1:.*]] = oq3.variable_load @result : !quir.cbit<10>
// MLIR: %[[BIT4:.*]] = oq3.cbit_extractbit(%[[LOAD1]] : !quir.cbit<10>) [4] : i1
// MLIR: %[[LOAD2:.*]] = oq3.variable_load @result : !quir.cbit<10>
...
// MLIR: %[[LOAD3:.*]] = oq3.variable_load @result : !quir.cbit<10>
...
// MLIR: %[[LOAD4:.*]] = oq3.variable_load @result : !quir.cbit<10>
...
// MLIR: %[[LOAD5:.*]] = oq3.variable_load @result : !quir.cbit<10>
// MLIR: %{{.*}} = "oq3.cast"(%[[LOAD5]]) : (!quir.cbit<10>) -> i32
if (result == 1) {
    U(0, 0, 0) $0;
}

// MLIR-DAG: %[[CBITS:.*]] = oq3.variable_load @cbits : !quir.cbit<10>
// MLIR-DAG: %[[RESULT:.*]] = oq3.variable_load @result : !quir.cbit<10>
