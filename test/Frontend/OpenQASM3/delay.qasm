...
// MLIR-NO-CIRCUITS: {{.*}} = quir.constant #quir.duration<5.000000e+00> : !quir.duration<ns>
...
// MLIR-NO-CIRCUITS: {{.*}} = quir.constant #quir.duration<1.000000e+01> : !quir.duration<ns>
// MLIR: quir.delay {{.*}}, ({{.*}}) : !quir.duration<ns>, (!quir.qubit<1>) -> ()
// AST-PRETTY: DelayStatementNode(DelayNode(duration=10Nanoseconds, qubit=IdentifierNode(name=$1, bits=1), ))
delay[10ns] $1;
// MLIR-NO-CIRCUITS: {{.*}} = quir.constant #quir.duration<2.000000e+01> : !quir.duration<us>
...
delay[20us] $1;
// MLIR-NO-CIRCUITS: {{.*}} = quir.constant #quir.duration<3.000000e+01> : !quir.duration<ms>
...
delay[30ms] $1;
// MLIR-NO-CIRCUITS: {{.*}} = quir.constant #quir.duration<4.000000e+01> : !quir.duration<dt>
...
// MLIR-CIRCUITS: {{.*}} = quir.constant #quir.duration<5.000000e+00> : !quir.duration<ns>
// MLIR-CIRCUITS: {{.*}} = quir.constant #quir.duration<1.000000e+01> : !quir.duration<ns>
// MLIR-CIRCUITS: {{.*}} = quir.constant #quir.duration<2.000000e+01> : !quir.duration<us>
// MLIR-CIRCUITS: {{.*}} = quir.constant #quir.duration<3.000000e+01> : !quir.duration<ms>
