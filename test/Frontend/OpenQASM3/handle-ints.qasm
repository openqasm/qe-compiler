...
// MLIR: oq3.assign_variable @x : i32 = %c100_i32
// MLIR: %c100_i32_0 = arith.constant 100 : i32
// MLIR: oq3.assign_variable @y : i32 = %c100_i32_0
...
// MLIR: oq3.assign_variable @a : i3 = %c1_i3
// MLIR: %c4_i32 = arith.constant 4 : i32
// MLIR: oq3.assign_variable @b : i32 = %c4_i32
...
// MLIR: oq3.assign_variable @a : i3 = [[CAST_A]]
// MLIR: %c3_i32_2 = arith.constant 3 : i32
// MLIR: oq3.assign_variable @b : i32 = %c3_i32_2
  a = 2;
  b = 3;
  U(0, 0, 0) $0;
}
