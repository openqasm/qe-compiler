...
#ifndef SIMULATOR_FUNCTION_LOCALIZATION_H
#define SIMULATOR_FUNCTION_LOCALIZATION_H
...
struct SimulatorFunctionLocalizationPass
    : public mlir::PassWrapper<SimulatorFunctionLocalizationPass,
                               mlir::OperationPass<mlir::ModuleOp>> {
...
#endif // SIMULATOR_FUNCTION_LOCALIZATION_H
