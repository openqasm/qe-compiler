...
#define DEBUG_TYPE "SimulatorFunctionLocalization"
...
auto SimulatorFunctionLocalizationPass::lookupQubitId(const Value val) -> int {
...
auto SimulatorFunctionLocalizationPass::getCallArgIndex(CallOpTy &callOp) -> int {
  int callArgIndex = -1;
...
template <class CallOpTy>
auto SimulatorFunctionLocalizationPass::getMatchedOp(CallOpTy &callOp,
                                                int callArgIndex,
                                                int thisIdIndex)
    -> Operation * {
...
template <class CallOpTy>
auto SimulatorFunctionLocalizationPass::getMangledName(CallOpTy &callOp)
    -> std::string {
...
template <class CallOpTy>
void SimulatorFunctionLocalizationPass::cloneMatchedOp(CallOpTy &callOp,
...
void SimulatorFunctionLocalizationPass::runOnOperation() {
  ModuleOp moduleOp = getOperation();
...
} // SimulatorFunctionLocalizationPass::runOnOperation

llvm::StringRef SimulatorFunctionLocalizationPass::getArgument() const {
  return "simulator-function-localization";
}

llvm::StringRef SimulatorFunctionLocalizationPass::getDescription() const {
  return "Copy and localize functions for Simulator code blocks.";
}
