...
//===----------------------------------------------------------------------===//
//
// Definition of utility functions for the Simulator
//
//===----------------------------------------------------------------------===//
...
auto qssc::targets::simulator::getControllerModule(ModuleOp topModuleOp)
    -> ModuleOp {
...
auto qssc::targets::simulator::getActuatorModules(ModuleOp topModuleOp)
    -> std::vector<ModuleOp> {
