// RUN: echo "{}" > %t
// RUN: qss-compiler -X=qasm --emit=mlir --target aer-simulator --config %t %s --num-shots=1 --break-reset --simulator-output-cregs --quir-eliminate-variables --simulator-quir-to-aer | FileCheck %s
