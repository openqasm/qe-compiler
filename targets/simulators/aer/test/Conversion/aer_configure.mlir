// RUN: echo "{" > %t
// RUN: echo "  \"method\" : \"MPS\"," >> %t
// RUN: echo "  \"device\" : \"gpu\"," >> %t
// RUN: echo "  \"precision\" : \"double\"" >> %t
// RUN: echo "}" >> %t
...
// CHECK: module {
  ...
  // CHECK: llvm.mlir.global {{.*}}("double\00")
  // CHECK-NEXT: llvm.mlir.global {{.*}}("precision\00")
  // CHECK-NEXT: llvm.mlir.global {{.*}}("GPU\00")
  // CHECK-NEXT: llvm.mlir.global {{.*}}("device\00")
  // CHECK-NEXT: llvm.mlir.global {{.*}}("matrix_product_state\00")
  // CHECK-NEXT: llvm.mlir.global {{.*}}("method\00")
