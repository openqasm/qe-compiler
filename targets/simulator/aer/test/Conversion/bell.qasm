// RUN: touch test.cfg
// RUN: qss-compiler -X=qasm --emit=mlir --target simulator --config test.cfg %s --num-shots=1 --simulator-output-cregs --quir-eliminate-variables --simulator-quir-to-aer | FileCheck %s
